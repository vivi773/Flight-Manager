    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Flights", x => x.AirlineID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FlightAirlineID = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reservations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Reservations_Flights_FlightAirlineID",
                        column: x => x.FlightAirlineID,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_FlightAirlineID",
                table: "Reservations",
                column: "FlightAirlineID");
        }
